...
namespace DVLD.People
{
    public partial class frmAddUpdatePerson : Form
    {
        ...
        public void RotateImageIfHorizontal(PictureBox pictureBox)
        {
            if (pictureBox.Image != null)
            {
                ...
                if (pictureBox.Image.Width > pictureBox.Image.Height)
                {
                    ...
                    Image rotatedImage = new Bitmap(pictureBox.Image);

                    // Rotate the image by 90 degrees clockwise
                    rotatedImage.RotateFlip(RotateFlipType.Rotate90FlipNone);

                    // Set the rotated image back to the PictureBox
        ...
        private void _LoadData()
        {
            ...
            if (_Person.ImagePath != "")
            {
                ...
                RotateImageIfHorizontal(pbPersonImage);
            }
